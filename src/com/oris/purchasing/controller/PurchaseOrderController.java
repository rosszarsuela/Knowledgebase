package com.oris.purchasing.controller;
...
@Controller
@RequestMapping(value="/secured/admin/order")
public class PurchaseOrderController extends BaseController {
	protected static Logger logger = Logger.getLogger(PurchaseOrderController.class);
	...
	public String registrationForm(@ModelAttribute("productCommand") final Product product) {
		return ADD_EDIT_PRODUCT;
	}
