...
public class InitialRenewalBillingUtil extends BasePDFGenUtil{
	private static final String directory = "D:/EGG Projects/HMODemo/Per Module Docs/Admin/Billing/PDF/InitialRenewal.pdf";
	...
	private static final String TRANSACTION_INITIAL = "INITIAL";
	...
	private static PdfPTable createComputationDetailsTable() {
		...
		PdfPTable computationDetailsTable = new PdfPTable(21);
		...
		computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
		computationDetailsTable.addCell(PDFUtil.createPdfPCell(NAF,  helvetica6Bold, ALIGN_CENTER, padding,  true, WHITE));
		computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
		computationDetailsTable.addCell(PDFUtil.createPdfPCell(DF,  helvetica6Bold, ALIGN_CENTER, padding,  true, WHITE));
		computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
		computationDetailsTable.addCell(PDFUtil.createPdfPCell(TOTAL,  helvetica6Bold, ALIGN_CENTER, padding,  true, WHITE));
		computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
		...
		computationDetailsTable.addCell(PDFUtil.createPdfPCell(INITIAL,  helvetica6Bold, ALIGN_LEFT, padding,  colspan-10, true, WHITE));
		...
		for(int i = 0; i< 10 ; i++) {
			...
			computationDetailsTable.addCell(PDFUtil.createPdfPCell(amountFormat.format(i),  helvetica6, ALIGN_CENTER, padding,  true, WHITE));
			computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
			computationDetailsTable.addCell(PDFUtil.createPdfPCell(amountFormat.format(i+i),  helvetica6, ALIGN_CENTER, padding,  true, WHITE));
			computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
		}
		...
		computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
		computationDetailsTable.addCell(PDFUtil.createPdfPCell(TOTAL,  helvetica6Bold, ALIGN_LEFT, padding,  colspan-8,true, WHITE));
		computationDetailsTable.addCell(PDFUtil.createBlankPdfPCell(padding, 1, WHITE));
	...
	private static PdfPTable createSummaryOfTransactionsTable() {
		...
		summaryOfTransactionsTable.addCell(PDFUtil.createPdfPCell(TRANSACTION_INITIAL,  helvetica6, ALIGN_CENTER, padding,  true, WHITE));
