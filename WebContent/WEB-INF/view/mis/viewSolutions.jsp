...
<div class="container">	
	<form:form id="view_brand" action="/Oris/web/secured/admin/solution/view" method="post" commandName="solutionCommand">
		<div class="form-group">
        	<div class="col-lg-4">
      			<input type="text" class="form-control" name="name" placeholder="Search Solutions"/>
      		</div>
		</div>
		
		<div class="form-group">
			<div class="col-lg-8">
	      		<a class="btn btn-primary" href="<c:url value="/web/secured/admin/solution/form"/>">CREATE SOLUTION</a>
	      		<%-- <a class="btn btn-primary" href="<c:url value="/web/secured/admin/solution/pdf">
					...
					<tr>
						...
						<th>
							<a href="<c:url value="/web/secured/admin/solution/view">
									...
									<c:param name="begin" value="${page.currentPage}" />
									<c:param name="orderBy" value="s.name"/>
									<c:param name="sortBy" value="asc"/>
								</c:url>" > <img src="<c:url value="/images/up.png"/>" height="10px" width="10px" title="Asc">
							</a>
							Name
						...
						<th>
							<a href="<c:url value="/web/secured/admin/solution/view">
									...
									<c:param name="begin" value="${page.currentPage}" />
									<c:param name="orderBy" value="s.description"/>
									<c:param name="sortBy" value="asc"/>
								</c:url>" > <img src="<c:url value="/images/up.png"/>" height="10px" width="10px" title="Asc">
							</a>
							Description
					...
					<c:choose>
						<c:when test="${not empty page.content }">
							<c:forEach items="${page.content }" var="obj" varStatus="index">
								...
								<td class="td-center">
									<a href="<c:url value="/web/secured/admin/solution/edit">
