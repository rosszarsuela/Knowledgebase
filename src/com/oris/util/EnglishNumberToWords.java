...
public class EnglishNumberToWords {
	...
	public static String convert(double number) {
		...
		int cents = Integer.parseInt(snumber.substring(13,15));
		...
		default:
			tradCent = " and " + convertLessThanOneThousand(cents) + " cents";
			break;
		}
		
		tradCent = StringUtils.isNotEmpty(tradCent) ? tradCent : " only";
		result = result + tradThousand + " pesos " + tradCent;
	...
	public static void main(String[] args) {
		...
		System.out.println("*** " + EnglishNumberToWords.convert(99999.99));
