...
public class SimpleSmtpMessageService implements MessageService {

    protected SimpleSmtpServiceConfig config;
    
    public static final String SENDER_NAME = "Oris Dental";

    private final transient Logger log = LoggerFactory.getLogger(SimpleSmtpMessageService.class);

    public SimpleSmtpMessageService() {
        this(new SimpleSmtpServiceConfig());
    }


    public SimpleSmtpMessageService(SimpleSmtpServiceConfig config) {
        setConfig(config);
    }
