...
public class SimpleSmtpServiceConfig implements ServiceConfig {
    ...
    public SimpleSmtpServiceConfig() {
    ...
    public SimpleSmtpServiceConfig(String host, String username, String password) {
        this.host = host;
        this.username = username;
        this.password = password;
    }

    public SimpleSmtpServiceConfig(String protocol, String host, int port, String username, 
